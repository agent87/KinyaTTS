...
```
2. Kinyarwanda: After preparing a multi-speaker Kinyarwanda dataset, you can use the following command to train a model: 
```sh
nohup python3 Training/MB-iSTFT-VITS2/train_ms.py -c Training/MB-iSTFT-VITS2/configs/ms_ktjw_istft_vits2_base.json -m models/ktjw_base &>> train_ms_ktjw_istft.log &
```
## Credits
